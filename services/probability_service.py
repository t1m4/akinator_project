...
class ProbabilityService(object):
    ...
    def calculate_character_probability(self, character):
        # Prior
        init_character_probability = 1 / self.characters_count

        # Likelihood
        # TODO modify this to work effectively with don't recalculate previous probabilities(save them in answers)
